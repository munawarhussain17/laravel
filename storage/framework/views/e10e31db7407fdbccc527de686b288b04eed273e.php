                ...
                <tbody>
                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <th><?php echo e($post->id); ?></th>
                            ...
                            <td><a href="<?php echo e(route('posts.show',$post->id)); ?> " class="btn btn-default btn-block ">View</a></td>
                            <td><a href="<?php echo e(route('posts.edit',$post->id)); ?> " class="btn btn-default btn-block ">Edit</a></td>
